...
from hummingbot.connector.exchange.hoo.hoo_user_stream_data_source import HooUserStreamDataSource
...
class HooUserStreamTracker(UserStreamTracker):
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        ...
        if not self._data_source:
            self._data_source = HooUserStreamDataSource(
                auth=self._auth,
